  ...
  <div class="container main-nav">
    ...
    <!-- ! Main -->
     <?php
        ...
        $sql = "SELECT COUNT(*) AS jumlah FROM pelanggan WHERE status='In'"; // Nama tabel
     ...
     <?php
        // Query untuk menghitung jumlah pelanggan
        $sqlpending = "SELECT COUNT(*) AS jumlah FROM pelanggan WHERE status='Pending'"; // Nama tabel
        $resultpending = $koneksi->query($sqlpending);

        // Ambil hasil
        if ($resultpending) {
            $rowpending = $resultpending->fetch_assoc();
            $jumlahpending = $rowpending['jumlah'];
        } else {
            $jumlahpending = 'Error: ' . $koneksi->error;
        }
     ?>
          ...
          <div class="col-md-6 col-xl-3">
            <article class="stat-cards-item">
              ...
              <div class="stat-cards-info">
                ...
                <p class="stat-cards-info__title">Tamu</p>
              </div>
            </article>
          </div>
          <div class="col-md-6 col-xl-3">
            <article class="stat-cards-item">
              ...
              <div class="stat-cards-info">
                <p class="stat-cards-info__num"><?php echo htmlspecialchars($jumlahpending); ?></p>
                <p class="stat-cards-info__title">Pending</p>
              </div>
            </article>
          </div>
        </div>
          ...
          <div class="col-lg-12">
            ...
            <table class="posts-table">
                ...
                <tbody>
                    ...
                    $query = "SELECT * FROM pelanggan WHERE status='In' OR status='Pending' ORDER BY status='In' DESC";
                    ...
                    ?>
                            <tr>
                                ...
                                <td><?php echo $r_tampil['jenis_paket']; ?></td>
