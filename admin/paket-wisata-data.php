...
$pict = isset($data['pict']) ? htmlspecialchars($data['pict']) : '';
...
<div class="layer"></div>
    ...
    <div class="page-flex">
        ...
        <div class="main-wrapper">
            ...
            $sql = "SELECT COUNT(*) AS jumlah FROM paket_wisata_revisi "; // Nama tabel
                        ...
                        <div class="col-md-6 col-xl-3">
                            <article class="stat-cards-item">
                                ...
                                <div class="stat-cards-info">
                                    ...
                                    <p class="stat-cards-info__title">Paket Wisata</p>
                                </div>
                            </article>
                        </div>
                    </div>
                            ...
                            <div class="users-table table-wrapper">
                                <table class="posts-table">
                                    ...
                                    <tbody>
                                        ...
                                        $query = "SELECT * FROM paket_wisata_revisi 
                                        ORDER BY 
                                          CASE 
                                        ...
                                        ?>
                                                <tr>
                                                    <td><?php echo $r_tampil['id_paket_wisata']; ?></td>
                                                    <td><?php echo $r_tampil['kode_paket']; ?></td>
                                                    <td><?php echo $r_tampil['nama_paket']; ?></td>
                                                    <td><?php echo $r_tampil['deskripsi']; ?></td>
                                                    <td><img src="<?php echo $r_tampil['pict']; ?>" alt="Preview" width="100"></td>
                                                    <td><?php echo "Rp " . number_format($r_tampil['harga_paket'], 0, ',', '.'); ?></td>
                                                    <td>
                                                        <a href="admin-edit-paket-wisata.php?id=<?php echo htmlspecialchars($r_tampil['id_paket_wisata']); ?>" class="btn btn-warning">Edit</a>
                                                        <a href="#" class="btn btn-danger" onclick="confirmDeletion(<?php echo $r_tampil['id_paket_wisata']; ?>)">Hapus</a>
                                                    </td>
                                                </tr>
                                        <?php
                                                $nomor++;
                ...
                function confirmDeletion(id) {
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            window.location.href = '../action/proses-admin-hapus-data-paket-wisata.php?id=' + id;
                        }
                    });
                }
            </script>
