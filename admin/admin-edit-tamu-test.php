  ...
  <div class="page-flex">
    ...
    <div class="main-wrapper">
      ...
      <div class="container mt-5">
        <h2>Edit Tamu</h2>
        <form action="../action/proses-edit-tamu.php" method="POST">
            <input type="hidden" name="id" value="<?php echo htmlspecialchars($data['id_pelanggan']); ?>">
            <div class="mb-3">
                <label for="nama_pelanggan" class="form-label">Nama Pelanggan</label>
                <input type="text" class="form-control" id="nama_pelanggan" name="nama_pelanggan" readonly value="<?php echo htmlspecialchars($data['nama_pelanggan']); ?>" required maxlength="100">
            </div>
            <div class="mb-3">
                <label for="jenis_paket" class="form-label">Jenis Paket</label>
                <input type="text" class="form-control" id="jenis_paket" name="jenis_paket" value="<?php echo htmlspecialchars($data['jenis_paket']); ?>" required maxlength="100">
            </div>
            <div class="mb-3">
                <label for="tgl_cekin" class="form-label">Tanggal Check In</label>
                <input type="date" class="form-control" id="tgl_cekin" name="tgl_cekin" value="<?php echo htmlspecialchars($data['tgl_cekin']); ?>" required>
            </div>
            <div class="mb-3">
                <label for="tgl_cekout" class="form-label">Tanggal Check Out</label>
                <input type="date" class="form-control" id="tgl_cekout" name="tgl_cekout" value="<?php echo htmlspecialchars($data['tgl_cekout']); ?>" required>
            </div>
            <div class="mb-3">
                <label for="status" class="form-label">Status</label>
                <select class="form-select" id="status" name="status" required>
                    <option value="In" <?php echo $data['status'] == 'In' ? 'selected' : ''; ?>>In</option>
