...
<div class="main-wrapper">
        <main class="main users chart-page" id="skip-target">
            <div class="container">
                <h2 class="main-title">Tambah Data Galery</h2>
                <div class="row">
                    <div class="col-lg-12">
                        <div class="users-table table-wrapper">
                            <form id="add-package-form" action="../action/proses-admin-tambah-data-galery.php" method="POST" enctype="multipart/form-data">
                                <label class="form-label-wrapper">
                                    <p class="form-label">Nama Gambar</p>
                                    <input class="form-input" type="text" placeholder="Nama Gambar" name="namagambar" required>
                                </label>
                                <label class="form-label-wrapper">
                                ...
                                <label class="form-label-wrapper">
                                    ...
                                    <input class="form-input" type="text" placeholder="Deskripsi Gambar" name="deskripsi" required>
                                </label>
