...
<div class="main-wrapper">
        <main class="main users chart-page" id="skip-target">
            <div class="container">
                <h2 class="main-title">Tambah Data Paket</h2>
                <div class="row">
                    <div class="col-lg-12">
                        <div class="users-table table-wrapper">
                            <form id="add-package-form" action="" method="POST" enctype="multipart/form-data">
                                <label class="form-label-wrapper">
                                    <p class="form-label">Kode Paket</p>
                                    <input class="form-input" type="text" placeholder="Kode Paket" name="kodepaket" required>
                                </label>
                                <label class="form-label-wrapper">
                                    <p class="form-label">Nama Paket</p>
                                    <input class="form-input" type="text" placeholder="Nama Paket" name="namapaket" required>
                                </label>
                                <label class="form-label-wrapper">
                                    <p class="form-label">Deskripsi Paket</p>
                                    <input class="form-input" type="text" placeholder="Deskripsi Paket" name="deskripsipaket" required>
                                </label>
                                <label class="form-label-wrapper">
                                ...
                                <label class="form-label-wrapper">
                                    ...
                                    <input class="form-input" type="text" placeholder="Harga Kode Paket" name="hargapaket" required>
                                </label>
