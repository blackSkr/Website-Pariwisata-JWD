...
<head>
  ...
  <title>Daftar Pengunjung Belum Melakukan Pembayaran</title>
  <!-- Favicon -->
  ...
  <div class="page-flex">
    ...
    <div class="main-wrapper">
      ...
      <main class="main users chart-page" id="skip-target">
        <div class="container">
          <h2 class="main-title">Daftar Tamu Belum Melakukan Pembayaran</h2>
          <div class="row">
            <div class="col-lg-12">
              <div class="users-table table-wrapper">
                <table class="posts-table">
                  ...
                  <tbody>
                    ...
                    $query = "SELECT * FROM pelanggan WHERE status='Menunggu Pembayaran' ORDER BY tgl_cekin DESC";
