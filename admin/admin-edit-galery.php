              ...
              <div class="users-table table-wrapper">
                <table class="posts-table">
                  ...
                  <?php
                    ...
                    ?>
                       <form action="../action/proses-admin-edit-data-galery.php" method="post" enctype="multipart/form-data">
                        <input type="hidden" name="id_galery" value="<?php echo htmlspecialchars($idgalery); ?>">
                        <label class="form-label-wrapper">
                            <p class="form-label">ID Gambar</p>
                            <input class="form-input" type="text" name="idgambar" value="<?php echo htmlspecialchars($idgalery); ?>" required readonly>
                        </label>
                        <label class="form-label-wrapper">
                            <p class="form-label">Nama Gambar</p>
                            <input class="form-input" type="text" name="namagambar" value="<?php echo htmlspecialchars($namagambar); ?>" required>
                        </label>
                        <label class="form-label-wrapper">
                            <p class="form-label">Deskripsi Gambar</p>
