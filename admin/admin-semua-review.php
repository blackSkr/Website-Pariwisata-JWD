  ...
  <div class="container main-nav">
    ...
    <!-- ! Main -->
     <?php
        ...
        $sql = "SELECT COUNT(*) AS jumlah FROM review "; // Nama tabel
    ...
    <main class="main users chart-page" id="skip-target">
      <div class="container">
        <h2 class="main-title">Review Komentar</h2>
        ...
        <div class="row">
          <div class="col-lg-12">
            ...
            <tbody>
                ...
                $query = "SELECT * FROM review ORDER BY status='kurangaman' DESC";
                ...
                ?>
                    <tr>
                        <td><?php echo htmlspecialchars($row['id_user_review'] ?? ''); ?></td>
                        ...
                        <td>
                            <span class="p-relative">
                                ...
                                <ul class="users-item-dropdown dropdown">
                                    <li><a href="admin-edit-review.php?id=<?php echo htmlspecialchars($row['id_user_review'] ?? ''); ?>" class="btn btn-danger">Edit Status</a></li>
                                    <li><a href="#" class="btn btn-danger" onclick="confirmDeletion(<?php echo $row['id_user_review'] ?? 0; ?>)">Hapus</a></li>
                                </ul>
                            </span>
                        </td>
                    </tr>
...
function confirmDeletion(id) {
    if (confirm('Apakah Anda yakin ingin menghapus data ini?')) {
        window.location.href = '../action/proses-hapus-review.php?id=' + id;
    }
}
</script>
